...
const indicacao_cooperado_entity_1 = require("./entities/indicacao-cooperado.entity");
...
exports.IndicacoesModule = IndicacoesModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([indicacao_cooperado_entity_1.IndicacaoCooperado]),
        ],
    })
], IndicacoesModule);
